...
class GitHubClient {
  constructor(token) {
    this.org = process.env.GITHUB_ORG || 'yonasberhe23';
    this.repo = process.env.GITHUB_REPO || 'fleet-test';
    this.project = parseInt(process.env.GITHUB_PROJECT_NUMBER || '1', 10);
    this.projectOwnerType = process.env.GITHUB_PROJECT_OWNER || 'user';
...
---
*Auto-generated by [CI Failure Inspector](https://github.com/yonasberhe23/inspector)*`;
