 ...
 *   4. New issues are added to the project board under Backlog
 *
...
// Load .env file for local development (not present in CI)
...
async function main() {
  ...
  console.log(`Target: ${ process.env.GITHUB_ORG || 'yonasberhe23' }/${ process.env.GITHUB_REPO || 'fleet-test' }`);
