...
export class JenkinsClient {
  constructor(authToken) {
    const base = process.env.JENKINS_BASE_URL || 'https://your-jenkins-instance';
    const jobPath = process.env.JENKINS_JOB_PATH || 'rancher_qa/ui-automation-ansible-job';

    this.auth = authToken;
    this.jobUrl = `${ base }/${ toJobUrl(jobPath) }`;
  }
